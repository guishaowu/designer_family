...
from designer_family.objects import project as project_obj
from designer_family.objects import resource_class as rc_obj
from designer_family.objects import user as user_obj
from designer_family import policies
from designer_family.tests import fixtures
from designer_family.tests.functional.db import test_base as tb
from designer_family.tests.functional.fixtures import capture
...
class APIFixture(fixture.GabbiFixture):
    """Setup the required backend fixtures for a basic designer_family service."""
    ...
    def start_fixture(self):
        ...
        # If None /etc/designer_family/designer_family.conf is read and confuses results.
...
class OpenPolicyFixture(APIFixture):
    ...
    def start_fixture(self):
        ...
        # not really apply to most of designer_family resources since they do not
        # have a user_id/project_id attribute.
        rules = {}
        for rule in policies.list_rules():
            name = rule.name
            # Ignore "base" rules for role:admin.
            if name in ['designer_family', 'admin_api']:
                continue
            rules[name] = '@'
