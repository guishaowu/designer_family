...
from designer_family.objects import usage as usage_obj
...
class ResourceProviderTestCase(tb.PlacementDbBaseTestCase):
    ...
    @mock.patch('designer_family.objects.resource_provider.LOG')
...
class SharedProviderTestCase(tb.PlacementDbBaseTestCase):
    """Tests that the queries used to determine designer_family in deployments with
...
class TestEnsureAggregateRetry(tb.PlacementDbBaseTestCase):
    ...
    @mock.patch('designer_family.objects.resource_provider._ensure_aggregate')
