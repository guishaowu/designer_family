...
from designer_family.cmd import status
from designer_family import conf
from designer_family import db_api
from designer_family.objects import consumer
from designer_family.objects import resource_provider
from designer_family.tests.functional import base
from designer_family.tests.functional.db import test_consumer
...
class UpgradeCheckIncompleteConsumersTestCase(
    ...
    "designer_family-status upgrade check" command.
    """
    def setUp(self):
