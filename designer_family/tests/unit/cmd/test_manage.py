...
from designer_family.cmd import manage
...
class TestCommandParsers(testtools.TestCase):
    ...
    def test_commands_associated(self):
        ...
        for command, args in [
            ...
            with mock.patch('designer_family.cmd.manage.DbCommands.' +
...
class TestDBCommands(base.ContextTestCase):
    ...
    def test_online_migrations(self):
        ...
        with mock.patch('designer_family.cmd.manage.online_migrations',
                        new=mock_migrations):
