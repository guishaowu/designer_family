...
#    under the License.
"""Unit tests for the functions used by the designer_family API handlers."""
...
class PlacementLoggingTest(testtools.TestCase):
    ...
    @mock.patch("designer_family.handler.LOG")
    def test_404_no_error_log(self, mocked_log):
        ...
        environ['designer_family.context'] = context_mock
...
class ContentHeadersTest(testtools.TestCase):
    ...
    def setUp(self):
        ...
        config = mock.MagicMock()
        self.environ['designer_family.context'] = mock.MagicMock()
