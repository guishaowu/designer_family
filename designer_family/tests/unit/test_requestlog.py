...
"""Tests for the designer_family request log middleware."""
...
class TestRequestLog(testtools.TestCase):
    ...
    def setUp(self):
        ...
        # nor a microversion
        self.environ['designer_family.microversion'] = '2.1'
    ...
    def test_get_uri_knows_prefix(self):
        self.environ['SCRIPT_NAME'] = '/designer_family'
        req_uri = requestlog.RequestLog._get_uri(self.environ)
        self.assertEqual('/designer_family/resource_providers?name=myrp', req_uri)

    @mock.patch("designer_family.requestlog.RequestLog.write_log")
    @mock.patch("designer_family.requestlog.LOG")
