...
#    under the License.
"""Unit tests for the utility functions used by the designer_family API."""
...
from designer_family import lib as pl
...
class TestJSONErrorFormatter(testtools.TestCase):
    ...
    def setUp(self):
        ...
        # in the designer_family API. The fact that we only had a single version was
        # masking a bug in the utils code.
        _versions = [
            '1.0',
            '1.1',
        ]
        self.useFixture(fixtures.MonkeyPatch('designer_family.microversion.VERSIONS',
                                             _versions))
...
class TestPlacementURLs(base.ContextTestCase):
    ...
    def test_resource_provider_url_prefix(self):
        ...
        environ = {'SCRIPT_NAME': '/designer_family'}
        expected_url = ('/designer_family/resource_providers/%s'
    ...
    def test_resource_class_url_prefix(self):
        ...
        # application when it is hosted at a path/prefix.
        environ = {'SCRIPT_NAME': '/designer_family'}
        expected_url = '/designer_family/resource_classes/CUSTOM_BAREMETAL_GOLD'
        self.assertEqual(expected_url, util.resource_class_url(
            environ, self.resource_class))
...
class TestParseQsRequestGroups(testtools.TestCase):
    ...
    def do_parse(qstring, version=(1, 18)):
        ...
        req.environ['designer_family.microversion'] = mv_parsed
