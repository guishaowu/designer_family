...
#    under the License.
"""Handlers for designer_family API.
...
from designer_family.handlers import aggregate
from designer_family.handlers import allocation
from designer_family.handlers import allocation_candidate
from designer_family.handlers import inventory
from designer_family.handlers import reshaper
from designer_family.handlers import resource_class
from designer_family.handlers import resource_provider
from designer_family.handlers import root
from designer_family.handlers import trait
from designer_family.handlers import usage
...
ROUTE_DECLARATIONS = {
    ...
    # NOTE(cdent): This allows '/designer_family/' and '/designer_family' to
...
class PlacementHandler(object):
    ...
    def __call__(self, environ, start_response):
        ...
        context = environ['designer_family.context']
