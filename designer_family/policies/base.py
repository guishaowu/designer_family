...
rules = [
    # "designer_family" is the default rule (action) used for all routes that do
    ...
    policy.RuleDefault(
        ...
        deprecated_reason="This was a catch-all rule hard-coded into "
                          "the designer_family service and has been superseded by "
                          "granular policy rules per operation.",
        deprecated_since="18.0.0"),
    policy.RuleDefault(
        "admin_api",
        "role:admin",
        description="Default rule for most designer_family APIs.",
        scope_types=['system']),
]
