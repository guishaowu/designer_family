...
from designer_family import errors
from designer_family import exception
from designer_family.handlers import util as data_util
from designer_family import microversion
from designer_family.objects import allocation as alloc_obj
from designer_family.objects import resource_provider as rp_obj
from designer_family.policies import allocation as policies
from designer_family.schemas import allocation as schema
from designer_family import util
from designer_family import wsgi_wrapper
...
def create_allocation_list(context, data, consumers):
    ...
    :param context: The designer_family context.
...
def list_for_consumer(req):
    ...
    context = req.environ['designer_family.context']
...
def _resource_providers_by_uuid(ctx, rp_uuids):
    ...
    :param ctx: The designer_family context.
