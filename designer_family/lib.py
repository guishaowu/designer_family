...
"""Symbols intended to be imported by both designer_family code and designer_family API
consumers.  When designer_family is separated out, this module should be part of a
common library that both designer_family and its consumers can require."""
import re
...
from designer_family.schemas import common
...
class RequestWideParams(object):
    ...
    def __init__(self, limit=None, group_policy=None,
        ...
        :param limit: An integer, N, representing the maximum number of
                ...
                CONF.designer_family.randomize_allocation_candidates is True this
