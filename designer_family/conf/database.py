...
placement_db_group = cfg.OptGroup('placement_database',
                                  ...
                                  help="""
The *Placement API Database* is a the database used with the designer_family
service. If the connection option is not set, the designer_family service will
not start.
""")
