...
placement_group = cfg.OptGroup(
    ...
    help="Configuration options for connecting to the designer_family API service")
...
is determined.
"""),
    # TODO(mriedem): When designer_family is split out of nova, this should be
    ...
    cfg.StrOpt(
        ...
        deprecated_reason="""
This option was necessary when designer_family was part of nova but can now be
...
default value, you need to configure designer_family to use
``[oslo_policy]/policy_file`` with policy.yaml specifically since otherwise
that option defaults to policy.json.
""",
        help='The file that defines designer_family policies. This can be an '
...
# that package into designer_family.
